                ...
                <div class="col-sm-12">
                    <table id="example1" class="table table-bordered table-striped dataTable" role="grid"
                        ...
                        <tr role="row">
                            ...
                            <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"
                                aria-label="CSS grade: activate to sort column ascending" style="width: 110px;">Fecha Nacimiento
                            </th>
                            <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"
                                aria-label="CSS grade: activate to sort column ascending" style="width: 110px;">Especialidad
                            </th>
                            <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"
                                aria-label="CSS grade: activate to sort column ascending" style="width: 110px;">Almamater
                            </th>
                        </tr>
                        </thead>
                        <tbody>
                        <?php
                          echo `<tr role="row" class="odd">
                            <td class="sorting_1">`.$abogados["dni"].`</td>
                            <td>`.$abogados["nombre"].`</td>
                            <td>`.$abogados["apellido"].`</td>
                            <td>`.$abogados["correo"].`</td>
                            <td>`.$abogados["telefono"].`</td>
                            <td>`.$abogados["fecha_nac"].`</td>
                            <td>`.$abogados["especialidad"].`</td>
                            <td>`.$abogados["almamater"].`</td>
                        </tr>`?>
